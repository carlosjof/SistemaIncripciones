                ...
                if (this.estado == "0") {
                    ...
                    $.ajax({
                        ...
                        success: (response) => {
                            ...
                            } else { document.getElementById("mensaje").innerHTML = "No se pueden gudar la categoria" }
            ...
            success: (response) => {
                ...
                if (funcion == 0) {
                    if (response[0].estado) {
                        document.getElementById("titleCategoria").innerHTML = "Esta a punto de desactivar la categoria " + response[0].nombre;
                    } else {
                        document.getElementById("titleCategoria").innerHTML = "Esta a punto de activar la categoria " + response[0].nombre;
                    }
                } else {
