...
namespace SistemaPF.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<List<Usuario>> GetUsuario(string id) {
            ...
            //onjeto que dependa de la clase usuario
            List<Usuario> usuario = new List<Usuario>();
        ...
        public async Task<String> CreateUsario(string email, string phoneNumber, string passwordHash, string selectRole, ApplicationUser applicationUser) {
            var resp = "";
            applicationUser = new ApplicationUser {
                UserName = email,
                Email = email,
